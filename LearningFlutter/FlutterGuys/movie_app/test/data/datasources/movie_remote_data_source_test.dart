...
void main() {
  ...
  const tUrl =
      'https://api.themoviedb.org/3/trending/movie/day?api_key=360f8f47db5a601815eae0431db22ba5';
  const pUrl =
      'https://api.themoviedb.org/3/movie/popular?api_key=360f8f47db5a601815eae0431db22ba5';
  const sUrl =
      'https://api.themoviedb.org/3/search/movie?query=$tQuery&api_key=360f8f47db5a601815eae0431db22ba5';
