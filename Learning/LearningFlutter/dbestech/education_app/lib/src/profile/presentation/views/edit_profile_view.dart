  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AuthenticationBloc, AuthenticationState>(
      listener: (context, state) {
        if (state is AuthenticationUserUpdatedState) {
              ...
              TextButton(
                onPressed: () {
                  ...
                  if (passwordChanged) {
                    ...
                    bloc.add(
                      AuthenticationUpdateUserEvent(
                        action: UpdateUserActionEnums.password,
                        userData: jsonEncode(
                          {
                  ...
                  if (nameChanged) {
                    bloc.add(
                      AuthenticationUpdateUserEvent(
                        action: UpdateUserActionEnums.displayName,
                  ...
                  if (emailChanged) {
                    bloc.add(
                      AuthenticationUpdateUserEvent(
                        action: UpdateUserActionEnums.email,
                  ...
                  if (bioChanged) {
                    bloc.add(
                      AuthenticationUpdateUserEvent(
                        action: UpdateUserActionEnums.bio,
                  ...
                  if (imageChanged) {
                    bloc.add(
                      AuthenticationUpdateUserEvent(
                        action: UpdateUserActionEnums.profilePic,
